...
public class AddCommandParserTest {
    ...
    public void parse_repeatedValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INJURY_STATUS_DESC_BOB + TRAINING_GOAL_DESC_BOB + AVAILABILITY_DESC_BOB;
        ...
        assertParseFailure(parser,
                ...
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_ADDRESS,
                        ...
                        PREFIX_TRAINING_GOAL, PREFIX_AVAILABILITY, PREFIX_INJURY_STATUS));
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INJURY_STATUS_DESC_BOB + TRAINING_GOAL_DESC_BOB + AVAILABILITY_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INJURY_STATUS_DESC_BOB + TRAINING_GOAL_DESC_BOB + AVAILABILITY_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + INJURY_STATUS_DESC_BOB + TRAINING_GOAL_DESC_BOB + AVAILABILITY_DESC_BOB, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + INJURY_STATUS_DESC_BOB + TRAINING_GOAL_DESC_BOB + AVAILABILITY_DESC_BOB, Address.MESSAGE_CONSTRAINTS);
