...
public class ParserUtilTest {
    ...
    @Test
    public void parseTrainingGoal_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseTrainingGoal(null));
    }

    @Test
    public void parseTrainingGoal_validValueWithoutWhitespace_returnsTag() throws Exception {
        TrainingGoal expectedTag = new TrainingGoal(VALID_TRAINING_GOAL);
        assertEquals(expectedTag, ParserUtil.parseTrainingGoal(VALID_TRAINING_GOAL));
    }

    @Test
    public void parseTrainingGoal_validValueWithWhitespace_returnsTrimmedTag() throws Exception {
        String trainingGoalWithWhitespace = WHITESPACE + VALID_TRAINING_GOAL + WHITESPACE;
        TrainingGoal expectedTag = new TrainingGoal(VALID_TRAINING_GOAL);
        assertEquals(expectedTag, ParserUtil.parseTrainingGoal(trainingGoalWithWhitespace));
    }
